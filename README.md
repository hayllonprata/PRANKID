...
5. Para o 15% off ir junto, crie um cupom de 15% em **Marketing → Cupons** e cole o código em `/panel/config`. Com 2 ou mais itens o site monta `.../r/TOKEN:QTD?promocode=SEUCUPOM`. O cupom da Yampi incide no **pedido inteiro** (não dá para mandar desconto só de uma peça pela URL).
